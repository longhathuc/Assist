...
function(git_clone)
    ...
    cmake_parse_arguments(
            PARGS       # list of names of the boolean arguments (only defined ones will be true)                                                                                                  # prefix of output variables
            "QUIET"
            "ON_NEEDED" # Checkout only if needed
    ...
    if(NOT PARGS_DIRECTORY)
        set(PARGS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR})
    endif()


    if (GIT_FORCE_PULL)
        if (NOT ${GIT_FORCE_PULL})
            if(PARGS_ON_NEEDED)
                IF(EXISTS ${PARGS_DIRECTORY}/${PARGS_PROJECT_NAME})
                    return()
                endif()
            endif()
        endif()
